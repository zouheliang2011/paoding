...
public class CJKKnife implements Knife, DictionariesWare {
	...
	public CJKKnife(Dictionaries dictionaries,String itemcat) {
		setDictionaries(dictionaries,itemcat);
	}

	public void setDictionaries(Dictionaries dictionaries,String itemcat) {
		vocabulary = dictionaries.getVocabularyDictionary(itemcat);
	...
	protected void dissectIsolated(Collector collector, Beef beef, int offset,
			int limit) {
		System.out.println("发现孤立词："+beef.subSequence(offset, limit));
